...
const BeautyQuiz = () => {
  ...
  const questions = [
    {
      ...
      options: [
        { id: 0, text: "Very active and busy", points: { elegant: 1, bold: 3, natural: 2 } },
        { id: 1, text: "Relaxed and laid-back", points: { elegant: 2, bold: 1, natural: 3 } },
        { id: 2, text: "Professional and polished", points: { elegant: 3, bold: 2, natural: 1 } },
        { id: 3, text: "Creative and expressive", points: { elegant: 2, bold: 3, natural: 1 } }
      ]
    },
    {
      id: 2,
      ...
      options: [
        { id: 0, text: "Soft pastels and nudes", points: { elegant: 3, bold: 1, natural: 2 } },
        { id: 1, text: "Bold reds and deep colors", points: { elegant: 2, bold: 3, natural: 1 } },
        { id: 2, text: "Earthy and natural tones", points: { elegant: 1, bold: 1, natural: 3 } },
        { id: 3, text: "Bright and vibrant shades", points: { elegant: 1, bold: 3, natural: 2 } }
      ]
    },
    {
      id: 3,
      question: "How do you prefer to maintain your nails?",
      options: [
        { id: 0, text: "Low maintenance, quick touch-ups", points: { elegant: 1, bold: 2, natural: 3 } },
        { id: 1, text: "Regular salon visits", points: { elegant: 3, bold: 2, natural: 1 } },
        { id: 2, text: "DIY at home with quality products", points: { elegant: 2, bold: 1, natural: 3 } },
        { id: 3, text: "Frequent changes and experimenting", points: { elegant: 1, bold: 3, natural: 2 } }
      ]
    },
    {
      id: 4,
      question: "What's your ideal nail length?",
      options: [
        { id: 0, text: "Short and practical", points: { elegant: 1, bold: 1, natural: 3 } },
        { id: 1, text: "Medium length", points: { elegant: 3, bold: 2, natural: 2 } },
        { id: 2, text: "Long and dramatic", points: { elegant: 2, bold: 3, natural: 1 } },
        { id: 3, text: "Varies by mood", points: { elegant: 2, bold: 2, natural: 2 } }
      ]
    }
  ];
  ...
  const results = {
    elegant: {
      ...
      description: "You appreciate timeless beauty and sophisticated style. Your ideal manicure features clean lines, subtle colors, and impeccable finish.",
      recommendations: [
        "French manicure with a modern twist",
        "Nude and blush pink shades",
        "Matte top coats for sophistication",
        "Minimalist nail art"
      ],
    ...
    bold: {
      type: "Bold & Beautiful",
      description: "You love to make a statement with your style. Your perfect manicure features vibrant colors, dramatic designs, and eye-catching elements.",
      recommendations: [
    ...
    natural: {
      type: "Natural Beauty",
      description: "You prefer understated elegance that enhances your natural beauty. Your ideal manicure is effortless, healthy-looking, and versatile.",
      recommendations: [
        "Clear and sheer polishes",
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12 animate-fade-in">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-full px-6 py-2 mb-6">
                ...
                <span className="text-sm font-medium text-emerald-600">Quiz Complete!</span>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden animate-scale-in">
              <div className="md:flex">
                ...
                <div className="md:w-1/2 p-8">
                  ...
                  <div className="mb-8">
                    <h4 className="text-xl font-semibold text-gray-800 mb-4">Recommended for You:</h4>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-teal-500/10 to-cyan-500/10 rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-medium text-teal-600">Interactive Quiz</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <p className="text-xl text-gray-600">
              Discover your perfect nail style with our personalized beauty quiz
            </p>
          </div>
