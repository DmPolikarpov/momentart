...
const FeaturedArticles = () => {
  ...
  const { data: articles = [], isLoading, error } = useArticles(undefined, 6);

  const categories = [
    { id: 'all', label: 'All Articles', count: articles.length },
    { id: 'Manicure & Nail Art', label: 'Manicure', count: articles.filter(a => a.category === 'Manicure & Nail Art').length },
    { id: 'Eyelash Extensions', label: 'Eyelash', count: articles.filter(a => a.category === 'Eyelash Extensions').length },
    { id: 'Cosmetology Trends', label: 'Cosmetology', count: articles.filter(a => a.category === 'Cosmetology Trends').length },
    { id: 'Skincare & Wellness', label: 'Skincare', count: articles.filter(a => a.category === 'Skincare & Wellness').length }
  ];
      ...
      <section className="py-20 bg-white/50 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <Tabs value={activeCategory} onValueChange={setActiveCategory} className="mb-12">
            <TabsList className="grid w-full max-w-2xl mx-auto grid-cols-5 bg-white/80 backdrop-blur-sm shadow-lg rounded-full p-2">
                      ...
                      >
                        ...
                        <div className="p-6">
                          ...
                          <p className="text-gray-600 mb-4 line-clamp-3">
                            {article.excerpt || (article.content ? article.content.substring(0, 150) + '...' : 'No excerpt available')}
                          </p>
