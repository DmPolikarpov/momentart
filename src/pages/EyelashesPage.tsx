    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50">
      ...
      <section className="pt-24 pb-16 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/4 right-1/4 w-40 h-40 bg-purple-200/20 rounded-full animate-pulse-slow"></div>
          <div className="absolute bottom-1/3 left-1/4 w-28 h-28 bg-violet-200/30 rounded-full animate-float"></div>
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
